...
Originally by [donutdan4114](https://github.com/donutdan4114)
with edits/additions by [ry167](https://github.com/ry167)
...
You can include this library by editing your composer.json file and adding the repositories section and adding `"bxmas13/shopify": "1.2.2"` to the require section:
